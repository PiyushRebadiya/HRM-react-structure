...
const PoliciesForm = ({ onHide }) => {
    ...
    }, [formdate, loading, Descriptions,]); // Add any other dependencies as needed
                                ...
                                <div className="col-sm-12">
                                    <Row>
                                        <div className="form-group">
                                            ...
                                            <input className='form-control' value={Policies} placeholder='Policy Name' onChange={(event) => {
