...
function AnnouncementNewform(props) {
    const { } = props;
    return (
        <Modal
...
const AnnouncementMain = ({onHide }) => {
    const [payrollNew, setpayrollNew] = React.useState(false);
                        ...
                        <div className="card lobicard" data-sortable="true">
                            <div className="card-header">
                                <div className='title-download-section'>
                                    <div className="card-title custom_title">
                                        <h4 className='report-heading'>Announcement Notice</h4>
                                    </div>
                            ...
                            <div className="btn-group d-flex input-searching-main pt-3 pl-3 ps-3" role="group">
                                <div className="buttonexport" id="buttonlist">
                                    ...
                                    <Button className="btn btn-add rounded-2" onClick={() => setpayrollNew(true)}>
                                        <i className="fa fa-plus" /> Add Notice [F2]
                                    </Button>
                                    <AnnouncementNewform
                                        show={payrollNew}
                                        onHide={() => setpayrollNew(false)}
